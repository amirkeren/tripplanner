...
import com.trip.planner.sources.google.places.exception.GooglePlacesException;
...
import static com.trip.planner.sources.google.places.GooglePlaces.*;

/**
 * Represents a place returned by Google Places API_
 */
public class Place implements IGenericLocation {
    ...
    /**
     * Sets the {@link com.trip.planner.sources.google.places.GooglePlaces} client associated with this Place object.
     *
     * @param client to set
     * @return this
     */
    ...
    /**
     * Returns the {@link com.trip.planner.sources.google.places.Hours} for this place.
     *
    ...
    /**
     * Sets the {@link com.trip.planner.sources.google.places.Hours} of this place.
     *
    ...
    /**
     * Adds a collection of {@link com.trip.planner.sources.google.places.AltId}s.
     *
     * @param altIds to add
     * @return this
     */
    ...
    /**
     * Returns the {@link com.trip.planner.sources.google.places.Status} of this place.
     *
     * @return status
     */
    ...
    /**
     * Sets the {@link com.trip.planner.sources.google.places.Status} of this place.
     *
     * @param status to set
     * @return this
     */
    ...
    /**
     * Returns the {@link com.trip.planner.sources.google.places.Price} of this place.
     *
     * @return price
     */
    ...
    /**
     * Sets the {@link com.trip.planner.sources.google.places.Price} of this place.
     *
     * @param price to set
     * @return this
     */
     ...
     *
     * @return scope
     * @see com.trip.planner.sources.google.places.Scope
     */
    ...
    public GenericLocation toGenericLocation(Filter filter, String location) {
        return new GenericLocation(DataSource.GOOGLE_PLACES, getLocationId(), getLocationName(), getLocationRating(),
    ...
    public String getLocationId() {
        return StringUtils.isNotBlank(getPlaceId()) ? getPlaceId() : StringConstants.NO_VALUE_DEFAULT;
    }

    @Override
    public String getLocationName() {
        return StringUtils.isNotBlank(getName()) ? getName() : StringConstants.NO_VALUE_DEFAULT;
    }
    ...
    public int getLocationReviewsNumber() {
        return getReviews() != null ? getReviews().size() : 0;
    }

    @Override
    public String getLocationAddress() {
        return StringUtils.isNotBlank(getVicinity()) ? getVicinity() : null;
    }

    @Override
    public String getLocationWebsite() {
        return StringUtils.isNotBlank(getWebsite()) ? getWebsite() : StringConstants.NO_VALUE_DEFAULT;
    }

    @Override
    public String getLocationType() {
        StringBuilder sb = new StringBuilder();
        getTypes().forEach(type -> sb.append(type).append(","));
