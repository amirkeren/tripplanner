...
public class GooglePlaces implements GooglePlacesInterface {
    ...
    /**
     * Creates a new GooglePlaces object using the specified TripPlanner key and the specified {@link RequestHandler}.
     *
    ...
    /**
     * Creates a new GooglePlaces object using the specified TripPlanner key.
     *
     * @param apiKey that has been registered on the Google Developer Console
     */
    ...
    /**
     * Creates a new GooglePlaces object using the specified TripPlanner key and character encoding. Using a character encoding
