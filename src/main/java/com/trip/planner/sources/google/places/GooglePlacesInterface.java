...
/**
 * A Java binding for the Google Places TripPlanner:
...
public interface GooglePlacesInterface extends Types, Statuses {
    ...
    /**
     * The URL of which Google Places TripPlanner is located.
     */
    ...
    /**
     * Returns the TripPlanner key associated with this GooglePlaces object.
     *
     * @return api key
     */
    ...
    /**
     * Sets the TripPlanner key associated with this GooglePlaces object.
     *
     * @param apiKey to set
     */
     ...
     * {@link com.trip.planner.sources.google.places.exception.GooglePlacesException} will be thrown.
     *
     * @param lat    latitude
     * @param lng    longitude
     * @param limit  the maximum amount of places to return
     ...
     * @throws com.trip.planner.sources.google.places.exception.GooglePlacesException if 'keyword', 'name' or 'types' is not included.
     */
     ...
     * Places TripPlanner.  If the specified limit is greater than {@link #MAXIMUM_PAGE_RESULTS}, multiple HTTP GET requests
    ...
    /**
     * Returns the places at the specified latitude and longitude according to the "radar" method specified by Google
     * Places TripPlanner. No more than {@link #DEFAULT_RESULTS} will be returned and no more than one HTTP GET request will
     * be sent.
     *
     * @param lat         latitude
     * @param lng         longitude
    ...
    /**
     * Adds a new place to the Places TripPlanner and gets the newly created place if returnPlace is set to true.
     *
