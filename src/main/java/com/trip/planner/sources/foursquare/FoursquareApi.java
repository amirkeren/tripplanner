...
import com.trip.planner.sources.foursquare.entities.*;
import com.trip.planner.sources.foursquare.entities.notifications.Notification;
import com.trip.planner.sources.foursquare.io.*;
...
public class FoursquareApi {
  ...
  /**
   * Sets Foursquare TripPlanner version
   *
   * @param version
   *          Foursquare TripPlanner version
   */
   ...
   * The map is converted into parameters for the search TripPlanner call with key/value pairs matching
   ...
   * @param query
   * @param limit
   * @return Result<VenuesAutocompleteResult>  -- this is only minivenues as per the TripPlanner!
   *
   */
  ...
  /**
   * Multipart/mime TripPlanner request
   *
   * @param path TripPlanner endpoint
  ...
  /**
   * Handles normal TripPlanner request response
   *
  ...
  /**
   * Handles callback TripPlanner request response
   *
   * @param response raw response
   * @return ApiRequestResponse
   * @throws JSONException when JSON parsing error occurs
  ...
  /**
   * Class that holds TripPlanner request response
   *
